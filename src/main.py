...
from routes import produto_route, cliente_route,  venda_route, fornecedor_route, convenio_route, devolucao_route, funcionario_route, relatorios_route
...
app.include_router(relatorios_route.router)
